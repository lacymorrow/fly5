    ...
    <div className="antialiased w-full min-h-screen px-1 py-16 text-center flex items-center flex-col">
      ...
      <main id="main-content" role="main">
        ...
        <p className="font-bold text-2xl mb-8 lowercase">
          Aerial cinematography <span className="lowercase">with</span>{" "}
        ...
        <p className="max-w-xl mx-auto text-lg text-gray-700 mb-8 px-4">
          We specialize in cinematic drone footage for film, real estate,
          events, and commercial projects across the Charlotte, NC area. From
          breathtaking aerials to precision close-ups, FLY5 delivers footage
          that elevates your story.
        </p>
        ...
        <section className="max-w-2xl mx-auto mt-16 px-4 text-left">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">
            Professional Aerial Cinematography Services
          </h2>
          <p className="text-lg text-gray-700 mb-4">
            FLY5 brings a cinematic eye to every aerial production. Our team of
            licensed drone pilots and cinematographers work with the latest
            equipment to capture footage that transforms how your audience sees
            your project.
          </p>
          <p className="text-lg text-gray-700 mb-4">
            Whether you are producing a film, showcasing a property, documenting
            a construction site, or capturing a special event, our aerial
            perspectives add a dimension that ground-based cameras simply cannot
            achieve.
          </p>
          <p className="text-lg text-gray-700 mb-4">
            Based in Charlotte, North Carolina, we serve clients throughout the
            Southeast and beyond. Every project receives our full creative
            attention, from pre-production planning through final delivery.
          </p>
        </section>
      </main>
